...
export type PostPartsFragment = { __typename: 'Post', title: string, date: string, excerpt: string, coverImage?: string | null, body?: string | null };
...
export const ExperimentalGetTinaClient = () =>
  getSdk(
    generateRequester(
      createClient({
        url: "https://content.tinajs.io/2.4/content/81c94174-2689-4314-8d18-2c0b99c966b2/github/main",
        queries,
      })
    )
  )
