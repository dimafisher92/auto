...
export function WhyUs() {
  return (
    <section id="why-us" className="scroll-mt-20 bg-[#111111] py-20 lg:py-28">
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div>
            <h2 className="font-heading text-3xl font-bold uppercase tracking-wide text-[#f0f0f0] sm:text-4xl lg:text-5xl">
              Чому обирають{" "}
              <span className="text-[#f0e060]">4GEAR</span>?
            </h2>
            ...
            <ul className="mt-8 flex flex-col gap-4">
              {reasons.map((reason) => (
                <li key={reason} className="flex items-start gap-3">
                  <CheckCircle className="mt-0.5 h-5 w-5 shrink-0 text-[#f0e060]" />
                  <span className="text-[#f0f0f0]">{reason}</span>
                </li>
              ))}
            </ul>
          </div>
